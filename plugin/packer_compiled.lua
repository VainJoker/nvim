...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  edge = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/edge",
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  neovim = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/neovim",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  penvim = {
    loaded = true,
    path = "/home/vainjoker/.local/share/nvim/site/pack/packer/start/penvim",
